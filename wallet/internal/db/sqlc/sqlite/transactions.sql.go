...
func (q *Queries) ListCoinbaseRollbackRootsAtOrAboveHeight(ctx context.Context, blockHeight sql.NullInt64) ([]ListCoinbaseRollbackRootsAtOrAboveHeightRow, error) {
