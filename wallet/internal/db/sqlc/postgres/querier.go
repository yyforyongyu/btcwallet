...
type Querier interface {
	...
	//   cleanup pass.
	DeleteExpiredUtxoLeases(ctx context.Context, walletID int64) (int64, error)
	...
	ListActiveUtxoLeases(ctx context.Context, walletID int64) ([]ListActiveUtxoLeasesRow, error)
