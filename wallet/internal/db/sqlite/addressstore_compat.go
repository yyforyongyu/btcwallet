...
// GetManagedPubKeyAddressByPath is not yet implemented for the SQLite store.
...
// GetManagedPubKeyAddress is not yet implemented for the SQLite store.
...
// GetPrivKeyByPath is not yet implemented for the SQLite store.
...
// GetPrivKeyForAddress is not yet implemented for the SQLite store.
