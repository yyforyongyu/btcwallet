...
func (w *SQLiteWalletDB) CreateDerivedAccount(ctx context.Context,
	...
	err := w.ExecuteTx(ctx, func(qtx *sqlcsqlite.Queries) error {
		...
		row, err := sqliteAllocateAndCreateAccount(ctx, qtx, scopeID,
			params.Name)
		if err != nil {
...
func sqliteEnsureKeyScope(ctx context.Context, qtx *sqlcsqlite.Queries,
	...
	return ensureKeyScope(ctx,
		...
		}, qtx.CreateKeyScope, func(
			addrSchema ScopeAddrSchema,
		) sqlcsqlite.CreateKeyScopeParams {
...
func (w *SQLiteWalletDB) CreateImportedAccount(ctx context.Context,
	...
	err := w.ExecuteTx(ctx, func(qtx *sqlcsqlite.Queries) error {
		...
		props, err = createImportedAccount(
			...
			sqliteBuildCreateAccountSecretArgs(params),
			func(accountID int64) (*AccountProperties, error) {
				return sqliteGetAccountProps(ctx, qtx,
					accountID)
			},
		)
...
func sqliteGetAccountProps(ctx context.Context, qtx *sqlcsqlite.Queries,
	...
	return accountPropsRowToProps(
		row.AccountNumber, row.AccountName, row.OriginID,
...
// identical fields.
func sqliteAccountRowToInfo[T sqliteAccountInfoRow](row T) (
	*AccountInfo, error) {
	...
	return accountRowToInfo(base.AccountNumber, base.AccountName,
		base.OriginID, base.IsWatchOnly, base.Purpose, base.CoinType)
}
...
func (s sqliteAccountListQueries) byScope(ctx context.Context,
	...
	return listAccounts(ctx, s.q.ListAccountsByWalletScope,
...
func (s sqliteAccountListQueries) byName(ctx context.Context,
	...
	return listAccounts(ctx, s.q.ListAccountsByWalletAndName,
...
func (s sqliteAccountListQueries) all(ctx context.Context,
	...
	return listAccounts(ctx, s.q.ListAccountsByWallet,
		int64(query.WalletID), sqliteAccountRowToInfo)
}
...
func (s sqliteAccountGetQueries) byNumber(ctx context.Context,
	...
	return getAccount(ctx, s.q.GetAccountByWalletScopeAndNumber,
...
func (s sqliteAccountRenameQueries) byNumber(ctx context.Context,
	...
	return renameAccount(ctx,
		s.q.UpdateAccountNameByWalletScopeAndNumber,
...
func (s sqliteAccountRenameQueries) byName(ctx context.Context,
	...
	return renameAccount(ctx,
		s.q.UpdateAccountNameByWalletScopeAndName,
