...
CREATE TABLE tx_replacements (
    ...
    -- DB ID of the replacement edge, primary key.
    ...
    --
    -- NOTE: The default normalizes the session timestamp to UTC explicitly so
    -- replacement-edge ordering remains stable across sessions with different
    -- timezone settings.
