...
// ValidateWatchOnly prevents a watch-only wallet from receiving account
// private-key material. A signing wallet can still track an external XPub:
// importing its public key does not grant the wallet signing authority.
