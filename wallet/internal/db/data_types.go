...
type CreateWalletParams struct {
	...
	// HDSeed is the Hierarchical Deterministic (HD) seed for the new
	// wallet.
	HDSeed []byte
...
type ImportAccountParams struct {
	...
	// DryRunNumAddrs is the number of addresses to derive if DryRun is
	// true.
...
type ImportAddressParams struct {
	...
	// RescanFrom is the block from which to start the rescan. This
