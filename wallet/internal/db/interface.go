...
type TxStore interface {
	...
	// that choice explicitly in CreateTxParams.
	...
	//
	// DeleteTx is intentionally narrower than "delete any blockless row".
...
type UTXOStore interface {
	...
	// balance policy from the public store interface.
