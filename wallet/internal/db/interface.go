...
type TxStore interface {
	...
	// InvalidateUnminedTx invalidates one unmined transaction branch as a single
	// atomic wallet event.
	//
	...
	// transaction and reconcile any dependent descendant state inside one database
	// transaction.
