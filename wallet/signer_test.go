...
func TestComputeRawSigFail(t *testing.T) {
	...
	// This subtest ensures that if fetching the key manager
	// fails during the raw signature computation, the error is
	// raw signature computation, the error is correctly propagated.
