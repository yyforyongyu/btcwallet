...
//
// Spendability defaults to the wallet mode unless the store overrides it
// for an imported account without a local signing path. Coinbase maturity
// remains a final per-output adjustment.
